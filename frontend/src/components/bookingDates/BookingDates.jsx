  ...
  return (
    <div className={`booking-dates ${className}`}>
      <div className="nights-count">
        ...
        <span>{booking.noOfPeople} Peoples:</span>
      </div>
      ...
      <div className="date-range">
        <div className="date-item">
          ...
          <span>
            {format(new Date(formatDate(booking.trip.startDate)), "yyyy-MM-dd")}
          </span>
        </div>
        ...
        <div className="date-item">
          ...
          <span>
            {format(new Date(formatDate(booking.trip.endDate)), "yyyy-MM-dd")}
          </span>
        </div>
      </div>
    </div>
